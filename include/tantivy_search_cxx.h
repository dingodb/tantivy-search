...
template <typename T>
typename Slice<T>::iterator &Slice<T>::iterator::operator+=(typename Slice<T>::iterator::difference_type n) noexcept {
...
template <typename T>
typename Slice<T>::iterator::difference_type Slice<T>::iterator::operator-(const iterator &other) const noexcept {
...
class layout {
  ...
  template <typename T>
  static typename std::enable_if<std::is_base_of<Opaque, T>::value, std::size_t>::type do_size_of() {
  ...
  template <typename T>
  static typename std::enable_if<detail::is_complete<T>::value, std::size_t>::type size_of() {
    return do_size_of<T>();
  }
  template <typename T>
  static typename std::enable_if<std::is_base_of<Opaque, T>::value, std::size_t>::type do_align_of() {
  ...
  template <typename T>
  static typename std::enable_if<detail::is_complete<T>::value, std::size_t>::type align_of() {
...
#ifndef CXXBRIDGE1_STRUCT_BM25Result
#define CXXBRIDGE1_STRUCT_BM25Result
struct BM25Result final {
...
#endif  // CXXBRIDGE1_STRUCT_BM25Result

#ifndef CXXBRIDGE1_STRUCT_BoolResult
#define CXXBRIDGE1_STRUCT_BoolResult
struct BoolResult final {
  bool result;
  ::std::int32_t error_code;
  ::rust::String error_msg;
...
::BoolResult ffi_varify_index_parameter(::std::string const &index_json_parameter) noexcept;
...
::BoolResult ffi_create_index_with_parameter(::std::string const &index_path,
                                             ::std::vector<::std::string> const &column_names,
                                             ::std::string const &index_json_parameter) noexcept;

// Create tantivy index by default.
// argements:
// - `index_path`: index directory.
// - `column_names`: which columns will be used to build index.
::BoolResult ffi_create_index(::std::string const &index_path,
                              ::std::vector<::std::string> const &column_names) noexcept;
...
::BoolResult ffi_index_multi_column_docs(::std::string const &index_path, ::std::uint64_t row_id,
                                         ::std::vector<::std::string> const &column_names,
                                         ::std::vector<::std::string> const &column_docs) noexcept;
...
::BoolResult ffi_delete_row_ids(::std::string const &index_path,
                                ::std::vector<::std::uint64_t> const &row_ids) noexcept;

// Commit index writer
// arguments:
// - `index_path`: index directory.
::BoolResult ffi_index_writer_commit(::std::string const &index_path) noexcept;

// Free index writer
// arguments:
// - `index_path`: index directory.
::BoolResult ffi_free_index_writer(::std::string const &index_path) noexcept;

// Load index writer
// arguments:
// - `index_path`: index directory.
::BoolResult ffi_load_index_writer(::std::string const &index_path) noexcept;

// Do index reader reload
// arguments:
// - `index_path`: index directory.
::BoolResult ffi_index_reader_reload(::std::string const &index_path) noexcept;

// Load index reader
// arguments:
// - `index_path`: index directory.
::BoolResult ffi_load_index_reader(::std::string const &index_path) noexcept;

// Free index reader
// arguments:
// - `index_path`: index directory.
::BoolResult ffi_free_index_reader(::std::string const &index_path) noexcept;
...
::BoolResult ffi_query_term_with_range(::std::string const &index_path, ::std::string const &column_name,
                                       ::std::string const &term, ::std::uint64_t lrange,
                                       ::std::uint64_t rrange) noexcept;
...
// - `lrange`: rowId left begin.
// - `rrange`: rowId right end.
::BoolResult ffi_query_terms_with_range(::std::string const &index_path, ::std::string const &column_name,
                                        ::std::vector<::std::string> const &terms, ::std::uint64_t lrange,
                                        ::std::uint64_t rrange) noexcept;
...
// - `lrange`: rowId left begin.
// - `rrange`: rowId right end.
::BoolResult ffi_query_sentence_with_range(::std::string const &index_path, ::std::string const &column_name,
                                           ::std::string const &sentence, ::std::uint64_t lrange,
                                           ::std::uint64_t rrange) noexcept;
...
// - `lrange`: rowId left begin.
// - `rrange`: rowId right end.
::BoolResult ffi_regex_term_with_range(::std::string const &index_path, ::std::string const &column_name,
                                       ::std::string const &pattern, ::std::uint64_t lrange,
                                       ::std::uint64_t rrange) noexcept;
...
// - `column_name`: which column will execute search.
// - `term`: term needs to be searched.
::rust::Vec<::std::uint8_t> ffi_query_term_bitmap(::std::string const &index_path, ::std::string const &column_name,
                                                  ::std::string const &term) noexcept;
...
::rust::Vec<::std::uint8_t> ffi_query_terms_bitmap(::std::string const &index_path, ::std::string const &column_name,
                                                   ::std::vector<::std::string> const &terms) noexcept;
...
// - `column_name`: which column will execute search.
// - `sentence`: sentence needs to be searched.
::rust::Vec<::std::uint8_t> ffi_query_sentence_bitmap(::std::string const &index_path, ::std::string const &column_name,
                                                      ::std::string const &sentence) noexcept;
...
// - `column_name`: which column will execute search.
// - `pattern`: pattern should be given by ClickHouse.
::rust::Vec<::std::uint8_t> ffi_regex_term_bitmap(::std::string const &index_path, ::std::string const &column_name,
...
::BM25Result ffi_bm25_search(::std::string const &index_path, ::std::string const &sentence, ::std::uint32_t topk,
                             ::std::vector<::std::uint8_t> const &u8_aived_bitmap, bool query_with_filter) noexcept;
...
// - `end_id`: id range end.
::BM25Result ffi_bm25_search_filter_ids(::std::string const &index_path, ::std::string const &sentence,
                                        ::std::uint32_t topk, ::std::vector<::std::uint64_t> const &alived_ids,
                                        bool query_with_filter, bool query_with_id_range, ::std::uint64_t start_id,
                                        ::std::uint64_t end_id) noexcept;
...
::BM25Result ffi_bm25_search_with_column_names(::std::string const &index_path, ::std::string const &sentence,
                                               ::std::uint32_t topk, ::std::vector<::std::uint64_t> const &alived_ids,
                                               bool query_with_filter, bool query_with_id_range,
                                               ::std::uint64_t start_id, ::std::uint64_t end_id,
                                               ::std::vector<::std::string> const &column_names) noexcept;
